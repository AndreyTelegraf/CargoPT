...
assert notify_job_control_about_unassigned_job is not None
...
assert "notify_job_control_about_unassigned_job" in source
...
assert "notify_job_control_about_unassigned_job(" not in request_submission_source
assert "notify_job_control_about_unassigned_job(" not in expiry_source
assert "notify_job_control_about_unassigned_job(" not in handler_source
