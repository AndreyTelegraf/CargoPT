...
def main() -> None:
    with TestClient(app) as client:
        checks = [
            ...
            ("/", 'placeholder="Obrigatório · DD/MM/AAAA, hoje, amanhã"'),
            ("/", 'name="client_phone" autocomplete="tel" placeholder="Obrigatório · +351..." required'),
            ("/", 'value="hoje"'),
            ("/", 'value="amanhã"'),
            ("/", 'value="próximos dias"'),
            ("/", 'value="qualquer dia"'),
            ("/", 'name="pickup_floor" type="number" min="-1" max="24" required'),
            ("/", 'name="pickup_elevator" required><option value="">Selecione · obrigatório</option>'),
            ("/", 'name="dropoff_floor" type="number" min="-1" max="24" required'),
            ("/", 'name="dropoff_elevator" required><option value="">Selecione · obrigatório</option>'),
            ("/en/", 'placeholder="Required · DD/MM/YYYY, today, tomorrow"'),
            ("/en/", 'name="client_phone" autocomplete="tel" placeholder="Required · +351..." required'),
            ("/en/", 'value="today"'),
            ("/en/", 'value="tomorrow"'),
            ("/en/", 'value="next few days"'),
            ("/en/", 'value="any day"'),
            ("/ru/", 'placeholder="Обязательно · ДД/ММ/ГГГГ, сегодня, завтра"'),
            ("/ru/", 'name="client_phone" autocomplete="tel" placeholder="Обязательно · +351..." required'),
            ("/ru/", 'value="сегодня"'),
            ("/ru/", 'value="завтра"'),
