...
def main() -> None:
    with TestClient(app) as client:
        checks = [
            ...
            ("/", "/assets/js/landing.js?v=urgent-policy-v1"),
            ("/en/", "/assets/js/landing.js?v=urgent-policy-v1"),
            ("/ru/", "/assets/js/landing.js?v=urgent-policy-v1"),
            ...
            ("/", 'name="needs_assembly"'),
            ("/en/", 'name="needs_packing"'),
            ("/ru/", 'name="needs_tail_lift"'),
            ("/", 'name="needs_crane"'),
            ("/en/", 'name="needs_mobile_lift"'),
            ("/", "support@cargopt.pt"),
            ("/en/", "Photos are not uploaded in this form."),
            ("/ru/", "Фотографии в эту форму не загружаются."),
            ("/assets/js/landing.js", 'needs_assembly: data.needs_assembly === "true"'),
            ("/assets/js/landing.js", 'needs_packing: data.needs_packing === "true"'),
            ("/assets/js/landing.js", 'needs_tail_lift: data.needs_tail_lift === "true"'),
            ("/assets/js/landing.js", 'needs_crane: data.needs_crane === "true"'),
            ("/assets/js/landing.js", 'needs_mobile_lift: data.needs_mobile_lift === "true"'),
            (
                "/",
            ...
            ("/assets/js/landing.js", "hasShortLeadRequestedDate"),
            ("/assets/js/landing.js", "Faltam menos de 72 horas."),
            ("/assets/js/landing.js", "The move is less than 72 hours away."),
            ("/assets/js/landing.js", "До перевозки меньше 72 часов."),
            ("/", 'id="requestLeadTimeNotice"'),
            ("/en/", 'id="requestLeadTimeNotice"'),
            ("/ru/", 'id="requestLeadTimeNotice"'),
            ...
            ("/mudancas-lisboa-porto/", "Mudanças entre Lisboa e o Porto"),
