...
def main() -> None:
    with TestClient(app) as client:
        checks = [
            ...
            ("/", "/assets/js/landing.js?v=international-address-v1-locale-transition-v1"),
            ("/en/", "/assets/js/landing.js?v=international-address-v1-locale-transition-v1"),
            ("/ru/", "/assets/js/landing.js?v=international-address-v1-locale-transition-v1"),
