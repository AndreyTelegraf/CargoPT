...
def main() -> None:
    with TestClient(app) as client:
        checks = [
            ...
            ("/", '<span class="field-label">De onde<span class="field-required" aria-hidden="true">*</span></span>'),
            ("/", '<span class="field-label">WhatsApp<span class="field-optional">opcional</span></span>'),
            ("/en/", '<span class="field-label">From<span class="field-required" aria-hidden="true">*</span></span>'),
            ("/en/", '<span class="field-label">WhatsApp<span class="field-optional">optional</span></span>'),
            ("/ru/", '<span class="field-label">Откуда<span class="field-required" aria-hidden="true">*</span></span>'),
            ("/ru/", '<span class="field-label">WhatsApp<span class="field-optional">необязательно</span></span>'),
            ("/assets/css/landing.css", ".request-form .field-required"),
            ("/assets/css/landing.css", 'content: "– "'),
            ("/", "landing.css?v=form-markers-v2"),
            ("/en/", "landing.css?v=form-markers-v2"),
            ("/ru/", "landing.css?v=form-markers-v2"),
            ("/assets/css/landing.css", ".field-optional"),
