...
Оставьте одну заявку через <a href="https://t.me/CargoPT_bot">@cargo_pt_bot</a>, а сервис передаст её подходящим транспортным компаниям.
...
Заполните заявку один раз через <a href="https://t.me/CargoPT_bot">@cargo_pt_bot</a> — подходящий исполнитель сам выйдет с вами на связь.""",

    """🚚 <b>Переезд, доставка мебели или техники?</b>

Пара минут на заявку в <a href="https://t.me/CargoPT_bot">@cargo_pt_bot</a> может сэкономить часы поиска перевозчика.
...
Опишите, что и куда нужно перевезти, через <a href="https://t.me/CargoPT_bot">@cargo_pt_bot</a>.
...
Заполните заявку через <a href="https://t.me/CargoPT_bot">@cargo_pt_bot</a>.
...
Опишите перевозку через <a href="https://t.me/CargoPT_bot">@cargo_pt_bot</a>.
